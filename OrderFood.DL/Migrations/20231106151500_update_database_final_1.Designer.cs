...
namespace OrderFood.DL.Migrations
{
    ...
    [Migration("20231106151500_update_database_final_1")]
    partial class update_database_final_1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderFood.Common.Models.BillDetail", b =>
                {
                    b.Property<Guid>("BillId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OrderFood.Common.Models.Book", b =>
                {
            ...
            modelBuilder.Entity("OrderFood.Common.Models.Food", b =>
                {
                    ...
                    b.Property<float?>("FoodDiscount")
                        .HasColumnType("real");

                    b.Property<int?>("FoodDiscountType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrderFood.Common.Models.BillDetail", b =>
                {
                    b.HasOne("OrderFood.Common.Models.Bill", "Bill")
                        .WithMany()
